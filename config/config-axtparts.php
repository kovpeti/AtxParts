...
// Author: Geoff Swan
// ********************************************
// $Id: config-axtparts.php 214 2018-01-07 11:13:25Z gswan $

if (!defined("_AXTPARTSDEFS"))
{
	define ("_AXTPARTSDEFS", true);
	
	define ("ENGPARTSVERSION", "3.18");
	
	// the database user information
	define ("PARTSUSER", "kovpeti");
	define ("PARTSPASSWD", "daragaluska");
	...
	$_cfg_stdtitle = "AXT Parts System";
	$_cfg_stdicon = "../images/icon-axtparts.ico";
	$_cfg_stdcss = array(
			"../core/css/axtparts.css",
	);
	$_cfg_stdjscript = array(
			"../core/js-forms.js",
	);
	
	$_cfg_btn_logout = array(
			"btnname" => "btn_logout",
			"label" => "Logout",
			"title" => "Log off the system",
			"onclick" => "javascript:top.location.href='logout.php'",
	);
	
	$_cfg_logoimgurl = "../images/logo.png";
	...
	// Maximum number of logs to show on the log page. Set to 0 for all logs
	define ("MAXLOGS", 1000);
	...
	UPRIV_FIELDRTN => "Edit field return details",
	UPRIV_FAULTDESCR => "Edit fault description details",
	...
	UPRIV_VIEWADDRESS => "View access to address book",
	UPRIV_VIEWASSY => "View access to assembly detail",
	UPRIV_VIEWUNIT => "View access to unit details",
	...
	// The tabs. Label => (url, click action, privilege)
	$_cfg_tabs = array(
		"Parts" => array("href" => "frm-parts.php", "onclick" => "return frmCheckDirty();", "tabpriv" => TABPRIV_PARTS),
		"Assembly" => array("href" => "frm-assembly.php", "onclick" => "return frmCheckDirty();", "tabpriv" => TABPRIV_ASSY),
		"Address" => array("href" => "frm-addressbook.php?show=all", "onclick" => "return frmCheckDirty();", "tabpriv" => TABPRIV_ADDRESS),
		"Admin" => array("href" => "frm-admin.php", "onclick" => "return frmCheckDirty();", "tabpriv" => TABPRIV_ADMIN),
		"Search" => array("href" => "frm-search.php", "onclick" => "return frmCheckDirty();", "tabpriv" => TABPRIV_SEARCH),
	);
