...
<section class="contentpanel">
	...
	<th class="pagebtn_c pagebtncell_on" width="13%"><span class="pagebtntext">States</span></th>
...
?>
	...
	<tr>
	<td width="75%" class="tablehead">Component State</td>
	<td width="25%" class="tablehead">Components Using</td>
	</tr>

	<tr class="tablelineadd" height="16">
<?php
if ($myparts->SessionMePrivilegeBit(UPRIV_COMPSTATES))
	print "<td class=\"tablelinktext\"><a href=\"javascript:popupOpener('pop-compstatus.php','pop_compstate',300,400)\" title=\"Add a new component status\">Add Status...</a></td>\n";
else
...
for ($i = 0; $i < $nd; $i++)
{
	...
	print "<td class=\"tablelinktext\"><a href=\"javascript:popupOpener('pop-compstatus.php?compstateid=".urlencode($dset[$i]["compstateid"])."','pop_compstate',300,400)\" title=\"View/Edit component status detail\">".htmlentities($dset[$i]["statedescr"])."</a></td>\n";
