...
<section class="contentpanel">
	...
	<th class="pagebtn_c pagebtncell_on" width="13%"><span class="pagebtntext">Footprints</span></th>
...
?>
	...
	<tr>
	<td width="75%" class="tablehead">Part Footprint</td>
	<td width="25%" class="tablehead">Parts Using</td>
	</tr>
...
for ($i = 0; $i < $nd; $i++)
{
	...
	print "<td class=\"tablelinktext\"><a href=\"javascript:popupOpener('pop-footprint.php?fprintid=".urlencode($dset[$i]["fprintid"])."','pop_fprint',300,400)\" title=\"View/Edit part footprint detail\">".htmlentities($dset[$i]["fprintdescr"])."</a></td>\n";
