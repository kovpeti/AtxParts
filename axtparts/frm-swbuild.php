...
<section class="contentpanel">
	...
	<th class="pagebtn_c pagebtncell_on" width="13%"><span class="pagebtntext">SW Build</span></th>
...
?>
	...
	<tr>
	<td width="30%" class="tablehead"><a href="<?php print $formfile."?sc=0&pg=".urlencode($pg) ?>" title="Sort by software name">Software Name</a></td>
	<td width="20%" class="tablehead"><a href="<?php print $formfile."?sc=1&pg=".urlencode($pg) ?>" title="Sort by build host">Build Host</a></td>
	<td width="20%" class="tablehead"><a href="<?php print $formfile."?sc=2&pg=".urlencode($pg) ?>" title="Sort by build image">Build Image</a></td>
	<td width="15%" class="tablehead"><a href="<?php print $formfile."?sc=3&pg=".urlencode($pg) ?>" title="Sort by release date">Release Date</a></td>
	<td width="15%" class="tablehead">Release Rev</td>
	</tr>

	<tr class="tablelineadd" height="16">
<?php
if ($myparts->SessionMePrivilegeBit(UPRIV_SWBUILD))
	print "<td class=\"tablelinktext\"><a href=\"javascript:popupOpener('pop-swbuild.php','pop_swbuild',300,400)\" title=\"Add a new software build\">Add SW Build...</a></td>\n";
else
...
for ($i = 0; $i < $nd; $i++)
{
	...
	print "<td class=\"tablelinktext\"><a href=\"javascript:popupOpener('pop-swbuild.php?swbuildid=".urlencode($dset[$i]["swbuildid"])."','pop_swbuild',300,400)\" title=\"View/Edit software build detail\">".htmlentities($dset[$i]["swname"])."</a></td>\n";
	print "<td class=\"tablelinktext\">".htmlentities($dset[$i]["buildhost"])."</td>\n";
	print "<td class=\"tablelinktext\">".htmlentities($dset[$i]["buildimage"])."</td>\n";
	print "<td class=\"tablelinktext\">".htmlentities($dset[$i]["releasedate"])."</td>\n";
	print "<td class=\"tablelinktext\">".htmlentities($dset[$i]["releaserev"])."</td>\n";
	print "</tr>\n";
}
?>
	</table>
